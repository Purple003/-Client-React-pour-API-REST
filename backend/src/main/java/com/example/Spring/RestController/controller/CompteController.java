package com.example.Spring.RestController.controller;

import com.example.Spring.RestController.entities.Compte;
import com.example.Spring.RestController.repositories.CompteRepository;
...
public class CompteController {
    ...
    @PostMapping(value = "/comptes", consumes = { "application/json", "application/xml" }, produces = {
    ...
    @PutMapping(value = "/comptes/{id}", consumes = { "application/json", "application/xml" }, produces = {
            "application/json", "application/xml" })
